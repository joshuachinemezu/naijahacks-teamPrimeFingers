...
<body>
	...
	<div class="bg-img1 size1 overlay1 p-t-0" style="background-image: url('images/bg01.jpg');">
		<div class="flex-w flex-sb-m p-l-80 p-r-74 p-b-17 respon5">
			<div class="wrappic1 m-r-30 m-t-30 m-b-10">
				<!-- <a href="#"><img src="images/icons/logo.png" alt="LOGO"></a> -->
				<a href="#"><span class="l1-txt2 p-b-45" style="font-size:30px; padding-top:100px">Noliah</span></a>
		...
		<div class="flex-w flex-sa p-r-200 respon1">
			<div class="p-t-34 p-b-60 respon3">
				<p class="l1-txt1 p-b-10 respon2">
					Something <span class="l1-txt2 p-b-45 respon2 respon4">awesome </span> is Loading...
				</p>
				<!-- <p class="l1-txt1 p-b-10 respon2">
