                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4">
                        <div class="comments-section">
                            <h2 class="com-title text-center">Sign up as a Tester</h2>
                            <div class="clearfix single-comment mdl-shadow--2dp jumbo-shadow">
                                <form class="matx-form-valid" method="post" name="frmChange" onSubmit="return submitAjaxForm(event)">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mdl-textfield mdl-js-textfield"><input class="mdl-textfield__input"
                                                    type="number" id="phone"><label class="mdl-textfield__label" for="phone">Phone</label></div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="mdl-textfield mdl-js-textfield"><input class="mdl-textfield__input"
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="text-center form-txt">Already have an Account? <a href="{{route('login')}}">Login
                                                here</a></p>
                                        <p class="text-center ">Not a Tester? <a href="{{ url('register/company') }}">Sign
                                                up
                                                as a Company</a></p>
                                    </div>
                                </form>
