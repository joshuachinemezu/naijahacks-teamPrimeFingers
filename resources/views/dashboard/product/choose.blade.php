                            ...
                            <div class="white-box">
                                <div class="row row-in">
                                    <div class="col-md-4 text-center">
                                        ...
                                        <a href="{{ url('create_product/prototype') }}" class="btn btn-prime">Test a Prototype</a>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        ...
                                        <a href="{{ url('create_product/web') }}" class="btn btn-prime">Test a Website</a>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        ...
                                        <a href="{{ url('create_product/app') }}" class="btn btn-prime">Test an App</a>
                                    </div>
                                </div>
                            </div>
                        </div>
