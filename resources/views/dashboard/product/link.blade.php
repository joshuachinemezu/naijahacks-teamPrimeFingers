                            ...
                            <div class="row row-in">
                                <div class="panel-wrapper collapse in" aria-expanded="true">
                                    <div class="panel-body">
                                        <form action="#">
                                            <div class="form-body">
                                                <h3 class="box-title m-b-20"><strong>Set questions (i.e see google
                                                        forms )</strong></h3>
                                                <a href="https://docs.google.com/forms/u/0/" target="_blank">Create a
                                                    google Form Now</a>
                                                <hr>
                                                <div class="row">
                                                    <div class="col-md-6">
                                ...
                                <div class="form-actions m-t-20">
                                    <a href="{{url('create_product/task/new')}}" class="btn btn-prime">Next</a>
                                </div>
